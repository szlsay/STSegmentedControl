...
@property (nonatomic, strong) STSegmentedControl *segmentedControl4;
...
- (void)viewDidLoad {
    ...
    self.title = @"STSegmentedControl Demo";
    ...
    STSegmentedControl *segmentedControl = [[STSegmentedControl alloc] initWithSectionTitles:@[@"Trending", @"News", @"Library"]];
    ...
    STSegmentedControl *segmentedControl1 = [[STSegmentedControl alloc] initWithSectionTitles:@[@"One", @"Two", @"Three", @"Four", @"Five", @"Six", @"Seven", @"Eight"]];
    segmentedControl1.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleWidth;
    segmentedControl1.frame = CGRectMake(0, 60, viewWidth, 40);
    segmentedControl1.segmentEdgeInset = UIEdgeInsetsMake(0, 10, 0, 10);
    segmentedControl1.selectionStyle = STSegmentedControlSelectionStyleFullWidthStripe;
    segmentedControl1.selectionIndicatorLocation = STSegmentedControlSelectionIndicatorLocationDown;
    ...
    [segmentedControl1 setTitleFormatter:^NSAttributedString *(STSegmentedControl *segmentedControl, NSString *title, NSUInteger index, BOOL selected) {
    ...
    segmentedControl2.selectionIndicatorLocation = STSegmentedControlSelectionIndicatorLocationDown;
    segmentedControl2.selectionStyle = STSegmentedControlSelectionStyleTextWidthStripe;
    ...
    STSegmentedControl *segmentedControl3 = [[STSegmentedControl alloc] initWithSectionTitles:@[@"One", @"Two", @"Three", @"4", @"Five"]];
    ...
    segmentedControl3.selectionStyle = STSegmentedControlSelectionStyleBox;
    segmentedControl3.selectedSegmentIndex = STSegmentedControlNoSegment;
    segmentedControl3.selectionIndicatorLocation = STSegmentedControlSelectionIndicatorLocationDown;
    segmentedControl3.shouldAnimateUserSelection = NO;
    segmentedControl3.tag = 2;
    [self.view addSubview:segmentedControl3];
    
    // Tying up the segmented control to a scroll view
    self.segmentedControl4 = [[STSegmentedControl alloc] initWithFrame:CGRectMake(0, 260, viewWidth, 50)];
    ...
    self.segmentedControl4.selectionStyle = STSegmentedControlSelectionStyleBox;
    self.segmentedControl4.selectionIndicatorLocation = STSegmentedControlSelectionIndicatorLocationUp;
...
- (void)segmentedControlChangedValue:(STSegmentedControl *)segmentedControl {
